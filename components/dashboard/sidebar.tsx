      ...
      >
        ...
        <div className="border-t border-white/10 p-4">
          <div className="rounded-2xl bg-white/10 p-4">
            <p className="text-sm font-bold">Build order</p>
            <p className="mt-1 text-xs leading-5 text-slate-300">Foundation first. Property marketplace next. Everything else later.</p>
          </div>
        </div>
      </aside>
    </>
