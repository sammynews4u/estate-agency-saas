...
export const demoNotifications = [
  { title: 'Foundation ready', message: 'Your role-based dashboard is available with working demo data.', type: 'success' },
  { title: 'Modules added', message: 'Property Marketplace and CRM are now available.', type: 'success' },
  { title: 'Supabase setup', message: 'Use demo mode now; connect Supabase when you are ready for production data.', type: 'info' },
];
...
export const dashboardStatsByRole: Record<RouteRole, { label: string; value: string; change: string }[]> = {
  ...
  agency: [
    ...
    { label: 'New Leads', value: '4', change: 'Working demo' },
    { label: 'Reports', value: 'Ready', change: 'Export available' },
  ],
  agent: [
    { label: 'My Leads', value: '2', change: 'Working demo' },
    { label: 'My Clients', value: '2', change: 'Working demo' },
    { label: 'Appointments', value: '0', change: 'Demo active' },
    { label: 'Commission', value: '₦0', change: 'Demo active' },
  ],
  client: [
    { label: 'Saved Properties', value: '2', change: 'Marketplace active' },
    { label: 'Inquiries Sent', value: '0', change: 'Demo active' },
    { label: 'Appointments', value: '0', change: 'Demo active' },
    { label: 'Documents', value: '0', change: 'Vault pending' },
  ],
  landlord: [
    { label: 'Submitted Properties', value: '2', change: 'Marketplace active' },
    { label: 'Inquiries', value: '0', change: 'Demo active' },
    { label: 'Valuations', value: '0', change: 'Demo active' },
    { label: 'Documents', value: '0', change: 'Vault pending' },
  ],
  'service-provider': [
    { label: 'Requests', value: '0', change: 'Demo active' },
    { label: 'Quotes', value: '0', change: 'Demo active' },
    { label: 'Portfolio Items', value: '0', change: 'Demo active' },
    { label: 'Reviews', value: '0', change: 'Demo active' },
  ],
  developer: [
    { label: 'Projects', value: '0', change: 'Demo active' },
    { label: 'Units', value: '0', change: 'Demo active' },
    { label: 'Sold Units', value: '0', change: 'Demo active' },
    { label: 'Progress', value: '0%', change: 'Demo active' },
  ],
  finance: [
    { label: 'Revenue', value: '₦0', change: 'Demo active' },
    { label: 'Expenses', value: '₦0', change: 'Demo active' },
    { label: 'Invoices', value: '0', change: 'Demo active' },
    { label: 'Payroll', value: '0', change: 'Demo active' },
  ],
};
